<!-- Documents http and management interface contracts. -->

# Support contract

HTTP and management interface contracts. The current files implement the cases and fixtures described below.
