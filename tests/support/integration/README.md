<!-- Documents real postgresql transaction and recovery tests. -->

# Support integration

Real PostgreSQL transaction and recovery tests. The current files implement the cases and fixtures described below.
...
`test_attempt_recovery.py`, `test_checkpoint_transactions.py`, `test_escalation.py`, `test_interrupt_recovery.py`, `test_migrations.py`, `test_recovery.py`, `test_repository.py`, `test_retention.py`.
