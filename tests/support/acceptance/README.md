<!-- Documents owned-process end-to-end acceptance. -->

# Support acceptance

Owned-process end-to-end acceptance. The current files implement the cases and fixtures described below.
...
`test_continuity.py`, `test_handoff.py`, `test_knowledge.py`, `test_load.py`, `test_security.py`.
